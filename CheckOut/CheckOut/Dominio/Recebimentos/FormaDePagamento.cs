...
{
    // Em JAVA, enum é uma classe já em C# não, será necessário está implementação para dar maior 
    // legibilidade ao código e evitar o uso da obsessão por tipos primitivos
    // Exemplos: 
